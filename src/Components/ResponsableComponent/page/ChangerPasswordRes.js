...
import res from'../../pics/res.png'

function ChangerPasswordRes() {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetch('http://localhost:8080/api/responsable/updatePassword', {
          method: 'POST',
          headers: {
          ...
          <div className="col-lg-4">
            <div className="card mb-4">
              <div className="card-body text-center">
                <img src={res} alt="avatar" className="rounded-circle img-fluid" style={{width: 150}} />
...
export default ChangerPasswordRes;
