...
function RegistreMorale (){
  ...
  const [nom_entreprise, setNomEn] = useState("");
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(`${API_BASE_URL}/registre`, { nom,prenom , email , password,mobile,date_nais,sexe,type_sang,localisation,nom_entreprise },
      {
        headers:{
...
<div className="row">
  <div className="col-md-6 mb-4">
    <div className="form-outline">
    <label className="form-label" htmlFor="form3Example1">Entreprise</label>
      <input type="text" id="form3Example1" className="form-control" 
       value={nom_entreprise}onChange={(event) => setNomEn(event.target.value)} required />
    </div>
  </div>
  <div className="col-md-6 mb-4">
    <div className="form-outline">
    <label className="form-label" htmlFor="form3Example2">Localisation</label>
      <input type="text" id="form3Example2" className="form-control" 
      value={localisation}onChange={(event) => setLocalisation(event.target.value)} required />
    </div>
  </div>
  </div>
<div className="row">
    ...
    <label className="form-label" htmlFor="form3Example2">Type de sang</label>
      <input type="text" id="form3Example2" className="form-control"
       value={type_sang}onChange={(event) => setTypesang(event.target.value)} required  />
         {bloodTypeError && <p className="error">{bloodTypeError}</p>}
      ...
      <div className="form-check">
        ...
        <label className="form-check-label" htmlFor="flexRadioDefault2">
          ...
          <div className="text-center">
                <p>Vous avez déjà un compte? <Link to="/LoginPM">Connexion</Link></p>
                </div>
        </form>
      </div>
    </div>
