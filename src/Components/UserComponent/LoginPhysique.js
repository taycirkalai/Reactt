      ...
      <center><h2 style={{marginTop:'-1%'}}>Connexion </h2></center>
        ...
        {emailError && <div className="alert alert-danger">{emailError}</div>}
          ...
          <div className="text-center">
                <p>Vous n'avez pas de compte?<Link to="/registerPH">Inscription</Link>
                <br></br>
                <Link to="/RestPasswordPH">Mot de passe oublier ?</Link></p>
                </div>
        </form>
      </div>
    </div>
