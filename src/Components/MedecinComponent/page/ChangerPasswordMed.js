...
import med from'../../pics/medprofil.png'

function ChangerPasswordMed() {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetch('http://localhost:8080/api/medecin/updatePassword', {
          method: 'POST',
          headers: {
      ...
      <div className="container py-5">
        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="card mb-4">
              <div className="card-body text-center">
                <img src={med} alt="avatar" className="rounded-circle img-fluid" style={{width: 160}} />
          ...
          <div className="col-lg-8">
            ...
            <Link className="btn btn-outline-danger mx-2" to={`/ProfilMed/${id}`}>
              Annuler
            </Link>
                </center>  
              </div>
...
export default ChangerPasswordMed;
