import NavBar from "./LayoutMedecin/Navbar";
import SideBar from "./LayoutMedecin/SideBar";
import React , {useEffect}  from "react";
import { Outlet} from "react-router-dom";
import { useNavigate } from 'react-router-dom';
import Footer from "./LayoutMedecin/Footer";
function DashboardMedComponent(){
...
export default DashboardMedComponent;